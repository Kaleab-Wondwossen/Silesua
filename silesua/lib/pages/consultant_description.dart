...
//import 'package:google_meet/google_meet.dart';
...
class ConsultantDescription extends StatelessWidget {
  ...
  void _launchGoogleMeet() async {
    const url = 'https://meet.google.com/'; // Google Meet URL
      ...
      appBar: AppBar(
        ...
        actions: [
          IconButton(
            ...
            icon: const FaIcon(Icons.meeting_room, color: Color.fromARGB(179, 17, 62, 198),),
          ),
        ],
        title: const Center(
          child: Text(
